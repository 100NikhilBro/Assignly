...
//   // Remove any interactive elements that shouldn't print
//   const interactiveElements = printContent.querySelectorAll('button, .no-print, input, .no-print *');
//   interactiveElements.forEach(el => el.remove());
...
//     // Get the attempt value from the data attribute or from sectionAttempts
//     let attemptValue = 0;
...
//     // If not found, try to get from sectionAttempts prop
//     if (totalQuestions === 0 && sectionAttempts[sectionTitle] !== undefined) {
//       const questions = section.querySelectorAll('.question-item');
//       totalQuestions = questions.length;
//       attemptValue = sectionAttempts[sectionTitle] || totalQuestions;
//     }
    
//     // If still not found, count questions
//     if (totalQuestions === 0) {
//       const questions = section.querySelectorAll('.question-item');
//       totalQuestions = questions.length;
//       attemptValue = totalQuestions;
//     }
    
//     // Remove existing attempt info display
//     const existingAttemptInfo = section.querySelector('.attempt-info-display');
//     if (existingAttemptInfo) {
//       existingAttemptInfo.remove();
//     }
