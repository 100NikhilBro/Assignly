...
// //             {/* Question Types - Responsive wrap */}
// //             <div>
// //               <label className="text-sm font-medium text-gray-700 mb-2 block flex items-center gap-2">
...
//                   >
//                     <ShieldAlert className="w-4 h-4 text-gray-400 cursor-help" />
//                     {showHackTooltip && (
//                       <div className="absolute right-0 bottom-full mb-2 w-64 bg-gray-900 text-white text-xs rounded-lg py-2 px-3 z-50 shadow-lg">
//                         <p className="font-semibold mb-1">💡 Pro Tip</p>
//                         <p>Set marks between 50-70 to get a well-balanced paper with extra questions for practice!</p>
//                         <div className="absolute right-2 -bottom-1 w-2 h-2 bg-gray-900 rotate-45"></div>
//                       </div>
//                     )}
//                   </div>
//                 </div>
