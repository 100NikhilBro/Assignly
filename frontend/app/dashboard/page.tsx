...
export default function DashboardPage() {
  ...
  const { user, token, logout, updateCredits } = useUserStore();
  ...
  return (
    <div className="relative min-h-screen bg-[#fdfaf5] overflow-x-hidden pb-20 sm:pb-0">
        ...
        <div className="hidden sm:block bg-gradient-to-r from-amber-50/80 to-amber-100/50 backdrop-blur-sm border border-amber-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8">
          ...
          {user?.credits === 0 && (
            <p className="text-amber-600 text-xs sm:text-sm mt-3">
               You have 0 credits. Please upgrade to create more assignments.
            </p>
          )}
        </div>
      ...
      {/* Profile Modal - Slide Up Animation */}
      {showProfileModal && (
        <>
          {/* Backdrop */}
          <div 
          ...
          {/* Modal Content */}
          <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-xl z-50 sm:hidden animate-slide-up">
            {/* Drag Handle */}
            ...
            <div className="px-5 py-4">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                ...
                <div className="bg-amber-50 rounded-xl p-3 text-center">
                  <Loader2 className="w-5 h-5 text-amber-600 mx-auto mb-1" />
            ...
            <div className="px-5 pb-6 pt-2 border-t border-gray-100">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-red-50 hover:bg-red-100 text-red-600 py-3 rounded-xl font-medium transition"
              >
